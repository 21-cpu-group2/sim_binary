...
min_caml_create_array:
    add %a2 %a0 %zero #%a0¢ğª³array length %a1¢ğª³?«±¡­«äªªª¿¢ğ?©¡©Ğ¢ğªª¢ğ©¡¢ğ¢ğ¢ğ«³
    add %a0 %min_caml_hp %zero # ª´ªÓ¢ğ«´ªªª¿¢ğª³array¢ğªÂ\?\ª±\«À\?¢ğ«Ò\?\ªª\ª²
create_array_loop:
    beq %a2 %zero create_array_exit # array length¢ğ?0¢ğª¢¢ğªª¢ğ¢Ä¢ğ«±?¢ìªÂ?
    sw %a1 %min_caml_hp 0                 # %a1¢ğ«Ò\«¡\«¤\«´¢ğª³?ª´ª®?
    addi %min_caml_hp %min_caml_hp 4       # hp¢ğ«Òª¡«ò¢ğ«£¢ğ?
    addi %a2 %a2 -1                      # array length¢ğ«Ò1¢±¢ë¢ğ«±¢ğ?
    beq %zero %zero create_array_loop    # create_array_loop¢ğª³\¢±\«ª\«Ñ\¡ß
create_array_exit:
    jalr %zero %ra 0 # ª´ªÓ¢ğ«´ªªª¿¢ğª³¢ğªÁ¡­«å¢ğª³array¢ğªÂ\?\ª±\«À\?¢ğ?©¡©Ğ¢ğªª¢ğ©¡¢ğ¢ğ¢ğ«³¢ğªÂ¢ğª®¢ğª´¢ğª³¢ğ«¤¢ğ?¢ğ¢ë?¢ìªÂ?

min_caml_create_float_array: # min_caml_create_array¢ğª²¢ğªÂ¡ë«ª¢ğ¢ğ¢ğªÁ?«±¡­«äªªª¿¢ğ?%f0¢ğª³©¡©Ğ¢ğªª¢ğ©¡¢ğ¢ğ¢ğ«³¢ğ?¢ğª²¢ğª¢¢ğ¡Ş
    add %a2 %a0 %zero #%a0¢ğª³array length %f0¢ğª³?«±¡­«äªªª¿¢ğ?©¡©Ğ¢ğªª¢ğ©¡¢ğ¢ğ¢ğ«³
    add %a0 %min_caml_hp %zero # ª´ªÓ¢ğ«´ªªª¿¢ğª³array¢ğªÂ\?\ª±\«À\?¢ğ«Ò\?\ªª\ª²
create_float_array_loop:
    beq %a2 %zero create_float_array_exit
    sw %f0 %min_caml_hp 0                 # %f0¢ğ«Ò\«¡\«¤\«´¢ğª³?ª´ª®?
    addi %min_caml_hp %min_caml_hp 4       # hp¢ğ«Òª¡«ò¢ğ«£¢ğ?
    addi %a2 %a2 -1
...
reduction_2pi:
    li %f1 l.1 # PI¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f2 l.2 # 2.0¢ğ«Ò\?\ªª\ª²
...
reduction_break2:
    jalr %zero %ra 0  # A¢ğªÁf0¢ğª³©¡©Ğ¢ğªª¢ğ©¡¢ğ¢ğ¢ğ«³¢ğªÂ¢ğª®¢ğ?¢ğªÂ¢ğ©°¢ğ©°?¢ìªÂ?

kernel_sin:
    li %f1 l.3 # S3¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f4 l.4 # S5¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f6 l.5 # S7¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    fmul %f2 %f0 %f0 # A^2
    fmul %f3 %f3 %f0 # A^3
...
kernel_cos:
    li %f1 l.6 # C1 (1.0) ¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f4 l.7 # C4 (1.0) ¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f6 l.8 # C6 (1.0) ¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    fmul %f2 %f0 %f0 # A^2
    fmul %f3 %f2 %f2 # A^4
    fmul %f5 %f2 %f3 # A^6
    fhalf %f2 %f2 # 0.5*A^2
...
min_caml_sin:
    fispos %a1 %f0 # %a1 = flag(%f0), %a0¢ğªÁreduction_2pi¢ğª®?ª²¢ğ¢Ã¢ğªÂ¢ğª®¢ğ?¢ğ?¢ğª®¢ğªÁ%a1¢ğ«Ò?ª²¢ğ¢Ã
    fabs %f0 %f0 # A = abs(A)
    sw %ra %sp 4
    addi %sp %sp 8
...
kernel_atan:
    li %f1 l.9 # A3¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f2 l.10 # A5¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f3 l.11 # A7¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f4 l.12 # A9¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f5 l.13 # A11¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f6 l.14 # A13¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª² PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    fmul %f7 %f0 %f0 # A^2
    fmul %f8 %f0 %f7 # A^3
    fmul %f9 %f7 %f8 # A^5
    fmul %f10 %f7 %f9 # A^7
...
min_caml_atan:
    fabs %f1 %f0 # |A|
    li %f2 l.15 # 0.4375 PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f3 l.16 # 2.4375 PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    li %f4 l.6 # 1.0 PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    ...
    lw %ra %sp 4
    li %f5 l.1 # PI PC¢ğªÂªªª¿¢ğ«Ò\?\ªª\ª²
    fhalf %f5 %f5 # PI/2
...
min_caml_print_char:
    ...
    addi %a3 %zero 32 # ¢ù«Øª®«Òª´¢±?«â
    slli %a3 %a3 8 # ¢ù«Øª®«Òª´¢±?«â¢ğ«Ò1byte¢ğ¢ë¢ğ«±¢ğ?
    add %a0 %a0 %a3 # 00 00 32 %a0
    slli %a3 %a3 8 # ¢ğ?¢ğ«±¢ğª³1byte¢ğ¢ë¢ğ«±¢ğ?
...
break_print_char:
    jalr %zero %ra 0  # ?¢ìªÂ?
break_print_charP3:
    slli %a2 %a2 8 # 51¢ğ«Ò1byte¢ğ¢ë¢ğ«±¢ğ?
    add %a0 %a0 %a2 # 00 00 51 80
    addi %a3 %zero 32 # ¢ù«Øª®«Òª´¢±?«â
    slli %a3 %a3 16 # ¢ù«Øª®«Òª´¢±?«â¢ğ«Ò2byte¢ğ¢ë¢ğ«±¢ğ?
