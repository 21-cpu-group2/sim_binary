...
l.6002:	# 0.000100
	953267991
l.5953:	# 100000000.000000
	1287568416
l.5947:	# 1000000000.000000
	1315859240
l.5924:	# -0.100000
	-1110651699
l.5910:	# 0.010000
...
xor.2233:
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8398
	addi %a0 %a1 0 #101
	jalr %zero %ra 0 #101
beq_else.8398:
	addi %a12 %zero 0
	bne %a1 %a12 beq_else.8399
	addi %a0 %zero 1 #101
	jalr %zero %ra 0 #101
beq_else.8399:
	addi %a0 %zero 0 #101
...
vecunit_sgn.2262:
	...
	lw %ra %sp 36 #169
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8407 # nontail if
	lw %a0 %sp 0 #169
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8409 # nontail if
	li %f0 l.5555 #169
	lw %f1 %sp 24 #169
	fdiv %f0 %f0 %f1 #169
	jal %zero beq_cont.8410 # then sentence ends
beq_else.8409:
	li %f0 l.5557 #169
	lw %f1 %sp 24 #169
	fdiv %f0 %f0 %f1 #169
beq_cont.8410:
	jal %zero beq_cont.8408 # then sentence ends
beq_else.8407:
	li %f0 l.5555 #169
beq_cont.8408:
	lw %a0 %sp 4 #168
...
beq_else.8421:
	...
	lw %a1 %sp 20 #640
	addi %a12 %zero 0
	bne %a1 %a12 beq_else.8422 # nontail if
	jal %zero beq_cont.8423 # then sentence ends
beq_else.8422:
	sw %a0 %sp 44 #670
...
beq_cont.8423:
	lw %a1 %sp 12 #640
	addi %a12 %zero 2
	bne %a1 %a12 beq_else.8424 # nontail if
	addi %a2 %zero 1 #679
	jal %zero beq_cont.8425 # then sentence ends
beq_else.8424:
	lw %a2 %sp 32 #679
beq_cont.8425:
	addi %a3 %zero 4 #680
	...
	sw %a1 %a12 0 #691
	addi %a12 %zero 3
	bne %a4 %a12 beq_else.8426 # nontail if
	lw %f0 %a2 0 #646
	sw %f0 %sp 56 #697
	...
	lw %ra %sp 68 #697
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8429 # nontail if
	lw %f0 %sp 56 #697
	sw %ra %sp 68 #697 call dir
	addi %sp %sp 72 #697	
	jal %ra sgn.2236 #697
	...
	lw %f1 %sp 64 #697
	fdiv %f0 %f1 %f0 #697
	jal %zero beq_cont.8430 # then sentence ends
beq_else.8429:
	li %f0 l.5553 #697
beq_cont.8430:
	lw %a0 %sp 24 #697
	...
	lw %ra %sp 84 #699
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8431 # nontail if
	lw %f0 %sp 72 #699
	sw %ra %sp 84 #699 call dir
	addi %sp %sp 88 #699	
	jal %ra sgn.2236 #699
	...
	lw %f1 %sp 80 #699
	fdiv %f0 %f1 %f0 #699
	jal %zero beq_cont.8432 # then sentence ends
beq_else.8431:
	li %f0 l.5553 #699
beq_cont.8432:
	lw %a0 %sp 24 #699
	...
	lw %ra %sp 100 #701
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8433 # nontail if
	lw %f0 %sp 88 #701
	sw %ra %sp 100 #701 call dir
	addi %sp %sp 104 #701	
	jal %ra sgn.2236 #701
	...
	lw %f1 %sp 96 #701
	fdiv %f0 %f1 %f0 #701
	jal %zero beq_cont.8434 # then sentence ends
beq_else.8433:
	li %f0 l.5553 #701
beq_cont.8434:
	lw %a0 %sp 24 #701
	sw %f0 %a0 8 #701
	jal %zero beq_cont.8427 # then sentence ends
beq_else.8426:
	addi %a12 %zero 2
	bne %a4 %a12 beq_else.8435 # nontail if
	lw %a1 %sp 32 #679
	addi %a12 %zero 0
	bne %a1 %a12 beq_else.8437 # nontail if
	addi %a1 %zero 1 #705
	jal %zero beq_cont.8438 # then sentence ends
beq_else.8437:
	addi %a1 %zero 0 #705
beq_cont.8438:
	add %a0 %a2 %zero
	...
	addi %sp %sp -112 #705
	lw %ra %sp 108 #705
	jal %zero beq_cont.8436 # then sentence ends
beq_else.8435:
beq_cont.8436:
beq_cont.8427:
	lw %a0 %sp 20 #640
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8439 # nontail if
	jal %zero beq_cont.8440 # then sentence ends
beq_else.8439:
	lw %a0 %sp 24 #710
	lw %a1 %sp 44 #710
...
solver_second.2418:
	...
	lw %a0 %sp 32 #864
	sw %f0 %sp 56 #864
	sw %ra %sp 68 #864 call dir
	addi %sp %sp 72 #864	
	jal %ra o_form.2292 #864
	addi %sp %sp -72 #864
	lw %ra %sp 68 #864
	addi %a12 %zero 3
	bne %a0 %a12 beq_else.8468 # nontail if
	li %f0 l.5555 #864
	lw %f1 %sp 56 #864
	fsub %f0 %f1 %f0 #864
	jal %zero beq_cont.8469 # then sentence ends
beq_else.8468:
	lw %f0 %sp 56 #818
beq_cont.8469:
	lw %f1 %sp 48 #866
	...
	fsub %f0 %f0 %f1 #866
	sw %f0 %sp 72 #868
	sw %ra %sp 84 #868 call dir
	addi %sp %sp 88 #868	
	jal %ra min_caml_fispos #868
	addi %sp %sp -88 #868
	lw %ra %sp 84 #868
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8470
	addi %a0 %zero 0 #856
	jalr %zero %ra 0 #856
beq_else.8470:
	lw %f0 %sp 72 #869
	sw %ra %sp 84 #869 call dir
	addi %sp %sp 88 #869	
	...
	lw %a0 %sp 32 #870
	sw %f0 %sp 80 #870
	sw %ra %sp 92 #870 call dir
	addi %sp %sp 96 #870	
	jal %ra o_isinvert.2296 #870
	addi %sp %sp -96 #870
	lw %ra %sp 92 #870
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8471 # nontail if
	lw %f0 %sp 80 #870
	sw %ra %sp 92 #870 call dir
	addi %sp %sp 96 #870	
	...
	addi %sp %sp -96 #870
	lw %ra %sp 92 #870
	jal %zero beq_cont.8472 # then sentence ends
beq_else.8471:
	lw %f0 %sp 80 #160
beq_cont.8472:
	lw %f1 %sp 48 #871
...
solver_rect_fast.2428:
	...
	lw %ra %sp 68 #899
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8477 # nontail if
	addi %a0 %zero 0 #899
...
beq_else.8477:
	...
	lw %ra %sp 76 #900
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8479 # nontail if
	addi %a0 %zero 0 #899
	jal %zero beq_cont.8480 # then sentence ends
beq_else.8479:
	lw %a0 %sp 24 #897
	lw %f0 %a0 4 #897
	sw %ra %sp 76 #901 call dir
	addi %sp %sp 80 #901	
	jal %ra min_caml_fiszero #901
	addi %sp %sp -80 #901
	lw %ra %sp 76 #901
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8481 # nontail if
	addi %a0 %zero 1 #901
	jal %zero beq_cont.8482 # then sentence ends
beq_else.8481:
	addi %a0 %zero 0 #899
beq_cont.8482:
beq_cont.8480:
...
beq_else.8486:
	lw %a0 %sp 24 #897
	lw %f0 %a0 12 #897
	sw %ra %sp 100 #910 call dir
	addi %sp %sp 104 #910	
	jal %ra min_caml_fiszero #910
	addi %sp %sp -104 #910
	lw %ra %sp 100 #910
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8488 # nontail if
	addi %a0 %zero 1 #910
...
beq_cont.8485:
	...
	lw %ra %sp 116 #917
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8491 # nontail if
	addi %a0 %zero 0 #898
...
beq_else.8493:
	lw %a0 %sp 24 #897
	lw %f0 %a0 20 #897
	sw %ra %sp 124 #919 call dir
	addi %sp %sp 128 #919	
	jal %ra min_caml_fiszero #919
	addi %sp %sp -128 #919
	lw %ra %sp 124 #919
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8495 # nontail if
	addi %a0 %zero 1 #919
	jal %zero beq_cont.8496 # then sentence ends
beq_else.8495:
	addi %a0 %zero 0 #898
beq_cont.8496:
beq_cont.8494:
...
solver_second_fast.2441:
	...
	lw %ra %sp 76 #946
	addi %a12 %zero 3
	bne %a0 %a12 beq_else.8504 # nontail if
	li %f0 l.5555 #946
	lw %f1 %sp 64 #946
	fsub %f0 %f1 %f0 #946
	jal %zero beq_cont.8505 # then sentence ends
beq_else.8504:
	lw %f0 %sp 64 #818
beq_cont.8505:
	lw %f1 %sp 56 #947
...
beq_else.8506:
	...
	lw %ra %sp 92 #949
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8507 # nontail if
	lw %f0 %sp 80 #952
...
beq_else.8516:
	lw %a0 %sp 4 #996
	sw %ra %sp 84 #996 call dir
	addi %sp %sp 88 #996	
	jal %ra o_isinvert.2296 #996
	addi %sp %sp -88 #996
	lw %ra %sp 84 #996
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8517 # nontail if
	lw %f0 %sp 72 #999
	sw %ra %sp 84 #999 call dir
	addi %sp %sp 88 #999	
	...
	lw %a0 %sp 0 #999
	sw %f0 %a0 0 #999
	jal %zero beq_cont.8518 # then sentence ends
beq_else.8517:
	lw %f0 %sp 72 #997
	sw %ra %sp 84 #997 call dir
	addi %sp %sp 88 #997	
...
beq_cont.8525:
	...
	lw %ra %sp 28 #1042
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8526 # nontail if
	lw %a0 %sp 0 #1045
	...
	fdiv %f0 %f0 %f1 #1046
	sw %f0 %a0 20 #1046
	jal %zero beq_cont.8527 # then sentence ends
beq_else.8526:
	li %f0 l.5553 #1043
	lw %a0 %sp 8 #1043
	sw %f0 %a0 20 #1043
...
setup_surface_table.2471:
	...
	lw %ra %sp 68 #1057
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8529 # nontail if
	li %f0 l.5553 #1065
	lw %a0 %sp 8 #1065
	sw %f0 %a0 0 #1065
	jal %zero beq_cont.8530 # then sentence ends
beq_else.8529:
	li %f0 l.5557 #1059
	lw %f1 %sp 56 #1059
	fdiv %f0 %f0 %f1 #1059
...
setup_second_table.2474:
	...
	lw %ra %sp 76 #1082
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8532 # nontail if
	lw %a0 %sp 8 #1087
	lw %f0 %sp 32 #1087
	sw %f0 %a0 4 #1087
	lw %f0 %sp 48 #1088
	...
	lw %f0 %sp 64 #1089
	sw %f0 %a0 12 #1089
	jal %zero beq_cont.8533 # then sentence ends
beq_else.8532:
	lw %a0 %sp 4 #1074
	lw %f0 %a0 8 #1074
	lw %a1 %sp 0 #1083
...
iter_setup_dirvec_constants.2477:
	...
	lw %ra %sp 28 #1104
	addi %a12 %zero 1
	bne %a0 %a12 beq_else.8537 # nontail if
	lw %a0 %sp 20 #1106
	lw %a1 %sp 8 #1106
	...
	add %a12 %a3 %a2 #1106
	sw %a0 %a12 0 #1106
	jal %zero beq_cont.8538 # then sentence ends
beq_else.8537:
	addi %a12 %zero 2
...
setup_startp_constants.2482:
	...
	lw %a1 %sp 20 #864
	addi %a12 %zero 2
	bne %a1 %a12 beq_else.8543 # nontail if
	lw %a1 %sp 12 #1132
	add %a0 %a1 %zero
...
beq_else.8543:
	addi %a12 %zero 2
	blt %a12 %a1 bge_else.8545 # nontail if
	jal %zero bge_cont.8546 # then sentence ends
bge_else.8545:
	lw %f0 %a0 0 #18
	lw %f1 %a0 4 #18
	lw %f2 %a0 8 #18
...
beq_else.8551:
	...
	lw %ra %sp 44 #1154
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8553 # nontail if
	addi %a0 %zero 0 #1153
	jal %zero beq_cont.8554 # then sentence ends
beq_else.8553:
	lw %f0 %sp 0 #1155
	sw %ra %sp 44 #1155 call dir
	addi %sp %sp 48 #1155	
...
is_second_outside.2497:
	...
	lw %ra %sp 20 #1170
	addi %a12 %zero 3
	bne %a0 %a12 beq_else.8560 # nontail if
	li %f0 l.5555 #1170
	lw %f1 %sp 8 #1170
	fsub %f0 %f1 %f0 #1170
	jal %zero beq_cont.8561 # then sentence ends
beq_else.8560:
	lw %f0 %sp 8 #818
beq_cont.8561:
	lw %a0 %sp 0 #1171
...
beq_else.8568:
	...
	sw %f0 %sp 40 #905
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8570 # nontail if
	addi %a0 %zero 0 #1214
	jal %zero beq_cont.8571 # then sentence ends
beq_else.8570:
	li %f1 l.5908 #1214
...
beq_else.8577:
	...
	sw %a0 %sp 16 #1255
	addi %a12 %zero 99
	bne %a8 %a12 beq_else.8578 # nontail if
	addi %a0 %zero 1 #1260
...
beq_else.8594:
	...
	lw %ra %sp 76 #1298
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8596 # nontail if
	jal %zero beq_cont.8597 # then sentence ends
beq_else.8596:
	li %f0 l.5910 #1300
	lw %f1 %sp 64 #1300
	fadd %f0 %f1 %f0 #1300
	...
	lw %ra %sp 108 #1304
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8598 # nontail if
...
beq_else.8602:
	...
	sw %a0 %sp 12 #1339
	addi %a12 %zero 99
	bne %a9 %a12 beq_else.8604 # nontail if
	addi %a3 %zero 1 #1343
	add %a1 %a8 %zero
	add %a0 %a3 %zero
	add %a11 %a7 %zero
...
beq_else.8606:
	...
	lw %ra %sp 36 #1350
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8608 # nontail if
	jal %zero beq_cont.8609 # then sentence ends
beq_else.8608:
	addi %a0 %zero 1 #1351
	lw %a1 %sp 16 #1351
	lw %a2 %sp 0 #1351
...
beq_else.8614:
	...
	lw %ra %sp 84 #1388
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8618 # nontail if
	jal %zero beq_cont.8619 # then sentence ends
beq_else.8618:
	lw %a0 %sp 20 #40
	lw %f1 %a0 0 #40
	lw %f0 %sp 72 #1389
	...
	lw %ra %sp 84 #1389
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8620 # nontail if
	jal %zero beq_cont.8621 # then sentence ends
beq_else.8620:
	li %f0 l.5910 #1391
	lw %f1 %sp 72 #1391
	fadd %f0 %f1 %f0 #1391
	...
	lw %ra %sp 116 #1395
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8622 # nontail if
	jal %zero beq_cont.8623 # then sentence ends
beq_else.8622:
	lw %a0 %sp 20 #1397
	lw %f0 %sp 104 #1397
	sw %f0 %a0 0 #1397
...
beq_else.8626:
	...
	sw %a0 %sp 12 #1430
	addi %a12 %zero 99
	bne %a8 %a12 beq_else.8628 # nontail if
	addi %a3 %zero 1 #1434
	add %a1 %a7 %zero
	add %a0 %a3 %zero
	add %a11 %a6 %zero
	...
	addi %sp %sp -24 #1434
	lw %ra %sp 20 #1434
	jal %zero beq_cont.8629 # then sentence ends
beq_else.8628:
	sw %a7 %sp 16 #1438
	sw %a6 %sp 20 #1438
	sw %a3 %sp 24 #1438
	...
	lw %ra %sp 36 #1438
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8630 # nontail if
	jal %zero beq_cont.8631 # then sentence ends
beq_else.8630:
	lw %a0 %sp 28 #36
	lw %f0 %a0 0 #36
	lw %a0 %sp 24 #40
	...
	lw %ra %sp 36 #1441
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8632 # nontail if
...
utexture.2559:
	...
	lw %a1 %sp 32 #784
	addi %a12 %zero 0
	bne %a1 %a12 beq_else.8645 # nontail if
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8647 # nontail if
	li %f0 l.6021 #1544
	jal %zero beq_cont.8648 # then sentence ends
beq_else.8647:
	li %f0 l.5553 #1544
beq_cont.8648:
	jal %zero beq_cont.8646 # then sentence ends
beq_else.8645:
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8649 # nontail if
	li %f0 l.5553 #1543
...
beq_else.8654:
	...
	lw %ra %sp 172 #1570
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8657 # nontail if
	lw %f0 %sp 120 #1573
	lw %f1 %sp 144 #1573
	fdiv %f0 %f1 %f0 #1573
...
beq_cont.8658:
	...
	lw %ra %sp 212 #1581
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8659 # nontail if
	lw %f0 %sp 160 #1584
	lw %f1 %sp 200 #1584
	fdiv %f0 %f1 %f0 #1584
...
beq_cont.8660:
	...
	lw %ra %sp 252 #1589
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8661 # nontail if
	lw %f0 %sp 240 #1588
...
trace_reflections.2566:
	...
	lw %ra %sp 68 #1622
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8671 # nontail if
...
beq_else.8671:
	...
	lw %ra %sp 76 #1625
	lw %a1 %sp 68 #1623
	bne %a1 %a0 beq_else.8673 # nontail if
	lw %a0 %sp 44 #32
	lw %a1 %a0 0 #32
	lw %a0 %sp 36 #1627
	lw %a11 %sp 40 #1627
...
beq_else.8691:
	lw %a0 %sp 108 #1644
	addi %a12 %zero 4
	blt %a0 %a12 bge_else.8693 # nontail if
	jal %zero bge_cont.8694 # then sentence ends
bge_else.8693:
	addi %a1 %a0 1 #1697
	addi %a2 %zero -1 #1697
	slli %a1 %a1 2 #1697
...
beq_else.8698:
	...
	lw %ra %sp 76 #1745
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8701 # nontail if
	li %f0 l.5553 #1745
...
trace_diffuse_ray_80percent.2589:
	...
	sw %a0 %sp 16 #1777
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8708 # nontail if
...
beq_cont.8709:
	lw %a0 %sp 16 #1777
	addi %a12 %zero 1
	bne %a0 %a12 beq_else.8710 # nontail if
...
beq_cont.8711:
	lw %a0 %sp 16 #1777
	addi %a12 %zero 2
	bne %a0 %a12 beq_else.8712 # nontail if
	jal %zero beq_cont.8713 # then sentence ends
beq_else.8712:
	lw %a1 %sp 12 #80
	lw %a2 %a1 8 #80
	lw %a3 %sp 4 #1786
...
do_without_neighbors.2602:
	...
	lw %a0 %a12 0 #1666
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8720 # nontail if
	jal %zero beq_cont.8721 # then sentence ends
beq_else.8720:
	lw %a0 %sp 8 #1845
	lw %a11 %sp 4 #1845
...
neighbors_exist.2605:
	...
	lw %a3 %a2 4 #56
	addi %a4 %a1 1 #1854
	blt %a4 %a3 bge_else.8724
	addi %a0 %zero 0 #1862
	jalr %zero %ra 0 #1862
bge_else.8724:
	addi %a12 %zero 0
	blt %a12 %a1 bge_else.8725
	addi %a0 %zero 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8725:
	lw %a1 %a2 0 #56
	addi %a2 %a0 1 #1856
	blt %a2 %a1 bge_else.8726
	addi %a0 %zero 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8726:
	addi %a12 %zero 0
	blt %a12 %a0 bge_else.8727
	addi %a0 %zero 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8727:
	addi %a0 %zero 1 #1858
...
beq_else.8734:
	...
	lw %a0 %a12 0 #1666
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8735 # nontail if
...
write_rgb_element.2627:
	...
	lw %ra %sp 4 #1927
	addi %a12 %zero 255
	blt %a12 %a0 bge_else.8739 # nontail if
	addi %a12 %zero 0
	blt %a0 %a12 bge_else.8741 # nontail if
	jal %zero bge_cont.8742 # then sentence ends
bge_else.8741:
	addi %a0 %zero 0 #1928
bge_cont.8742:
	jal %zero bge_cont.8740 # then sentence ends
bge_else.8739:
	addi %a0 %zero 255 #1928
bge_cont.8740:
...
bge_else.8753:
	...
	addi %a1 %zero 0 #2021
	addi %a12 %zero 0
	bne %a0 %a12 beq_else.8755 # nontail if
	lw %a0 %sp 32 #2018
	slli %a2 %a0 2 #2018
	lw %a3 %sp 20 #2018
	add %a12 %a3 %a2 #2018
	...
	addi %sp %sp -48 #2024
	lw %ra %sp 44 #2024
	jal %zero beq_cont.8756 # then sentence ends
beq_else.8755:
	lw %a0 %sp 32 #2022
	lw %a2 %sp 28 #2022
	lw %a3 %sp 8 #2022
...
bge_else.8757:
	...
	sw %a0 %sp 20 #2038
	sw %a5 %sp 24 #2038
	blt %a0 %a7 bge_else.8759 # nontail if
	jal %zero bge_cont.8760 # then sentence ends
bge_else.8759:
	addi %a7 %a0 1 #2039
	add %a2 %a4 %zero
	add %a1 %a7 %zero
